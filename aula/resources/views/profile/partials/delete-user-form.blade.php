<section class="rounded-lg border border-red-200 bg-white p-6 shadow-card">
    <header>
    ...
    <form method="POST" action="{{ route('profile.destroy') }}" class="mt-4 space-y-4"
        ...
        <button
            ...
            class="rounded-full border border-red-200 bg-white px-6 py-2 text-sm font-medium text-red-600 transition-fast hover:bg-red-50 focus-ring"
        >
            Eliminar cuenta
        </button>
