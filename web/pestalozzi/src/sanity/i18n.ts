...
export const UI = {
  es: {
    ...
    galeria: {
      filtrosAmbiente: 'Ambiente',
      filtrosCategoria: 'Categoría',
      filtroTodas: 'Todas',
      filtroTodasFotos: 'Todas las fotos',
      filtroMentesAbsorbentes: 'Mentes Absorbentes',
      filtroMentesRazonadoras: 'Mentes Razonadoras',
      filtroInstalaciones: 'Instalaciones',
      filtroActividades: 'Actividades',
      filtroDeportes: 'Deportes',
      filtroEventos: 'Eventos',
...
galeria: {
      filtrosAmbiente: 'Environment',
      filtrosCategoria: 'Category',
      filtroTodas: 'All',
      filtroTodasFotos: 'All photos',
      filtroMentesAbsorbentes: 'Absorbent Minds',
      filtroMentesRazonadoras: 'Reasoning Minds',
      filtroInstalaciones: 'Facilities',
      filtroActividades: 'Activities',
      filtroDeportes: 'Sports',
      filtroEventos: 'Events',
      fotografiaAmpliada: 'Enlarged photo',
      cerrar: 'Close',
      anterior: 'Previous',
      siguiente: 'Next',
      tituloPagina: 'Gallery | Pestalozzi Ambato Educational Unit',
